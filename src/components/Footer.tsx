      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t pt-14" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
          <div className="grid md:grid-cols-3 gap-10 mb-14">
            ...
            {/* About */}
            <div>
              <h3 className="font-display text-xl font-semibold text-white mb-4">Lina Milner</h3>
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.55)', lineHeight: '1.8' }}>
                Psychosexual therapist addressing intimacy issues after narcissistic abuse. Based in Harley Street, London W1G.
              </p>
            ...
            <div>
              ...
              <div className="space-y-3.5">
                ...
                >
                  ...
                  <span className="group-hover:text-white transition-colors">020 7467 8300</span>
                </a>
                <a
            ...
            <div>
              ...
              <div className="flex gap-3 mb-8">
                <a
                  href="#"
                  aria-label="Follow Lina on Instagram"
                ...
                <a
                  href="#"
                  aria-label="Connect with Lina on LinkedIn"
                  className="w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300"
                  style={{ backgroundColor: 'rgba(255,255,255,0.08)', color: 'rgba(255,255,255,0.5)' }}
                  onMouseEnter={e => {
                    const el = e.currentTarget as HTMLAnchorElement;
          ...
          >
            ...
            >
              <p>© 2025 Lina Milner Psychosexual Therapy. All rights reserved.</p>
